...
public class TemplateParser_Test
{
    ...
    public void full_token()
    {
        ...
        var template = TemplateParser.Parse(text);
    ...
    {
        var tokens = TemplateParser.Parse(text).Tokens;
    ...
    {
        var tokens = TemplateParser.Parse(template).Tokens;
    ...
    public void enable_cache()
    {
        ...
        (receiver[0] - receiver[1]).TotalMilliseconds.ShouldBeGreaterThan(0);
    }
}

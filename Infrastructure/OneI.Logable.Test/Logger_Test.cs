...
public class Logger_Test
{
    ...
    {
        var a2  = Environment.CommandLine; // 该进程的命令行 F:\Documents\Git\one\one-csharp\Infrastructure\OneI.Logable.Test\bin\Debug\net7.0\testhost.dll --port 3553 --endpoint 127.0.0.1:03553 --role client --parentprocessid 12860 --telemetryoptedin true
        var a3 = Environment.CurrentDirectory;// 当前工作目录的完全限定路径 F:\Documents\Git\one\one-csharp\Infrastructure\OneI.Logable.Test\bin\Debug\net7.0
        ...
        var a1 = Environment.ProcessPath;// 启动当前正在执行的进程的可执行文件的路径F:\Documents\Git\one\one-csharp\Infrastructure\OneI.Logable.Test\bin\Debug\net7.0\testhost.exe

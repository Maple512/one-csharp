...
using OneI.Buffers.IndexOfAnyValues;
...
internal readonly unsafe struct ProbabilisticMap
{
    ...
    public static int IndexOfAny(ref char searchSpace, int searchSpaceLength, ref char values, int valuesLength) =>
        IndexOfAny<ValueHelper.DontNegate<char>>(ref searchSpace, searchSpaceLength, ref values, valuesLength);

    public static int IndexOfAnyExcept(ref char searchSpace, int searchSpaceLength, ref char values, int valuesLength) =>
        IndexOfAny<ValueHelper.Negate<char>>(ref searchSpace, searchSpaceLength, ref values, valuesLength);

    public static int LastIndexOfAny(ref char searchSpace, int searchSpaceLength, ref char values, int valuesLength) =>
        LastIndexOfAny<ValueHelper.DontNegate<char>>(ref searchSpace, searchSpaceLength, ref values, valuesLength);

    public static int LastIndexOfAnyExcept(ref char searchSpace, int searchSpaceLength, ref char values, int valuesLength) =>
        LastIndexOfAny<ValueHelper.Negate<char>>(ref searchSpace, searchSpaceLength, ref values, valuesLength);

    private static int IndexOfAny<TNegator>(ref char searchSpace, int searchSpaceLength, ref char values, int valuesLength)
        where TNegator : struct, ValueHelper.INegator<char>
    {
        var valuesSpan = new ReadOnlySpan<char>(Unsafe.AsPointer(ref values), valuesLength);
        ...
        if(typeof(TNegator) == typeof(ValueHelper.DontNegate<char>)
    ...
    private static unsafe int LastIndexOfAny<TNegator>(ref char searchSpace, int searchSpaceLength, ref char values, int valuesLength)
        where TNegator : struct, ValueHelper.INegator<char>
    {
        var valuesSpan = new ReadOnlySpan<char>(Unsafe.AsPointer(ref values), valuesLength);
        ...
        where TNegator : struct, ValueHelper.INegator<char>
    {
        ...
        return typeof(TNegator) == typeof(ValueHelper.DontNegate<char>)

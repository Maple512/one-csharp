...
using OneI.Applicationable.Configuration;
using OneI.Applicationable.Infrastructure;
...
/// </summary>
/// <remarks>
/// source: <see href="https://github.com/dotnet/runtime/blob/844702d736eef2fc456c1e4d89043fab6d054609/src/libraries/Microsoft.Extensions.Configuration/src/ConfigurationManager.cs#L19"/>
/// </remarks>
internal sealed class ConfigurationManager : IConfigurationManager
{
    ...
    public string? this[string key]
    {
        get
        {
            ...
            return GetConfiguration(reference.Providers, key);
        }
        set
        {
            using var reference = _providerManager.GetReference();

            SetConfiguration(reference.Providers, key, value);
        }
    }

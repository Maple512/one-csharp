...
public static class HostingHostBuilderExtensions
{
    ...
    {
        var isDevelopment = context.Environment.IsDevelopment();
    ...
    [UnsupportedOSPlatform("ios")]
    [UnsupportedOSPlatform("tvos")]
    public static IHostBuilder UseConsoleLifetime(this IHostBuilder hostBuilder, Action<HostLifetimeOptions> configureOptions)
    {
    ...
    public static Task RunConsoleAsync(
        ...
        Action<HostLifetimeOptions> configureOptions,

...
internal static class ThrowHelper
{
    ...
    {
        throw new ArgumentOutOfRangeException(nameof(month), "Month must be between one and twelve.");
    }
    ...
    {
        throw new ArgumentException("Handle does not support synchronous operations. The parameters to the FileStream constructor may need to be changed to indicate that the handle was opened asynchronously (that is, it was opened explicitly for overlapped I/O).", paramName);
    }

    [DoesNotReturn]
    internal static void ThrowArgumentException_HandleNotAsync(string paramName)
    {
        throw new ArgumentException("Handle does not support asynchronous operations. The parameters to the FileStream constructor may need to be changed to indicate that the handle was opened synchronously (that is, it was not opened for overlapped I/O).", paramName);
    }
    ...
    {
        return new ArgumentException($"The value \"{key}\" is not of type \"{targetType}\" and cannot be used in this generic collection.", nameof(key));
    }

    private static ArgumentException GetWrongValueTypeArgumentException(object? value, Type targetType)
    {
        return new ArgumentException($"The value \"{value}\" is not of type \"{targetType}\" and cannot be used in this generic collection.", nameof(value));
    }
